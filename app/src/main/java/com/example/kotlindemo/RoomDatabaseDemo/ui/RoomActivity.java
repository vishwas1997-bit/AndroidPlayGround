package com.example.kotlindemo.RoomDatabaseDemo.ui;
...
import com.example.kotlindemo.RoomDatabaseDemo.adapter.CourseRVAdapter;
import com.example.kotlindemo.RoomDatabaseDemo.viewmodel.ViewModal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RoomActivity.this, NewCourseActivity.class);
        ...
        viewmodal.getCourse(getApplication());
